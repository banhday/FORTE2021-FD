...
MsgAgePowerSet == [ Proc -> [ Proc -> [ MsgAge -> BOOLEAN ]]]
...
Proc_Init ==
  /\ pc = [ p \in Proc |-> "send" ]
  /\ existMsgOfAge = [p \in Proc |-> [ q \in Proc |-> [ k \in MsgAge |-> FALSE ]]]       
...
AddNewMsgs ==
  /\ subround = "send"
  /\ subround' = "del" 
  /\ existMsgOfAge' = [ snder \in Proc |-> [ rcver \in Proc |-> [ k \in MsgAge |-> 
...
TypeOK ==
  ...
  /\ existMsgOfAge \in [ Proc -> [ Proc -> [ MsgAge -> BOOLEAN ]]]
...
\* Last modified Wed Apr 14 10:02:50 CEST 2021 by tran
