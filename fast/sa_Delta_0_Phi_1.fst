...
then print("Strong accuracy in the region with a big timeout default holds.");
else print("Strong accuracy in the region with a big timeout default does not hold.");
endif
